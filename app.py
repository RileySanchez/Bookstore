...
database_url = "postgresql:" + \
    ":".join(os.environ.get('DATABASE_URL', "").split(":")[1:])
...
def add_user():
    ...
    possible_duplicate = db.session.query(
    ...
    return jsonify('Congrats, you have signed up for an account!')
...
def update_book_by_id(id):
    ...
    db.session.commit()
    return jsonify('The book has been updated')
